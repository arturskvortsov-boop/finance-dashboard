...
function applyHideBalance(){
    var els=['totalBalanceRubDisplay','totalBalanceUsdDisplay','monthIncomeDisplay','monthExpenseDisplay','totalIncomeRubOnly','totalExpenseRubOnly','totalIncomeUsd','totalExpenseUsd','balanceUsd','netIncome','dayIncome','dayExpense','weekIncome','weekExpense','monthIncome','monthExpense','currencyHeroUsd','usdDetails','rateProfit','totalBalanceRubDisplay'];
